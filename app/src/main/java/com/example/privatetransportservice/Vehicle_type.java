    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerButton=findViewById(R.id.TypeVehRegisterBtn);
            ...
            b1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    count="2";
                    vehicleType=1;
                   // Vehicle_Info vehicle_info=new Vehicle_Info(2);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                vehicleType=2;
                count="4";
                /*Vehicle_data vehicle_data=new Vehicle_data(4);
        ...
        b4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                vehicleType=4;
                /*Other_Vehicle_Info other_vehicle_info=new Other_Vehicle_Info();
                other_vehicle_info.show(getSupportFragmentManager(),"layout dialogue other");*/
            }
        });
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(vehicleType<Integer.parseInt(count)){
                    Intent i=new Intent(Vehicle_type.this, normal_vehicle_data.class);
                    i.putExtra("count", count);
                    startActivity(i);
                }
                else if(vehicleType==Integer.parseInt(count)){
                    startActivity(new Intent(Vehicle_type.this, other_vehicle_data.class));
                }
                else {
                    Toast.makeText(Vehicle_type.this, "Please select type of vehicle", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
